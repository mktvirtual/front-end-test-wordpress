...
<html lang="pt-br">
	<head>
		...
		<!-- <link rel="stylesheet" type="text/css" href="css/font-awesome.min.css"/> If you are OFFLINE (CDN)--> 
		<!-- <link rel="stylesheet" type="text/css" href="css/bootstrap.min.css"/> If you are OFFLINE (CDN)--> 
	</head>
	<body>
		<header>
			<!-- TOP MENU -->
