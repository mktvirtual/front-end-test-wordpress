...
function wpb_custom_atalho_menu() {
  register_nav_menu('atalhos-menu',__( 'Atalhos' ));
}
add_action( 'init', 'wpb_custom_atalho_menu' );
...
function palm_beach_google_fonts_url() {
	...
	// Set default Fonts.
	$font_families = array( 'Alegreya+Sans:400,400i', 'Montserrat:400,400italic,700,700italic' );
