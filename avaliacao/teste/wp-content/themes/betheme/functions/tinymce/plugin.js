		...
		editor.addButton('mfnsc', {
			...
			menu : [ {
				...
				menu : [ {
					...
					text : 'Button',
					onclick : function() {
						editor.insertContent('[button title="Button" link="" target="_blank" align="" icon="" icon_position="" color="" font_color="" size="2" full_width="" class="" download="" rel="" onclick=""]');
					}
				}, {
					text : 'Code',
					onclick : function() {
				...
				menu : [ {
					...
					text : 'Hover Color',
					onclick : function() {
						editor.insertContent('[hover_color background="#2991D6" background_hover="#236A9C" border="" border_hover="" border_width="2px" padding="40px 30px" link="" target="" class="" style=""]Insert your content here[/hover_color]');
					}				
				}, {
					text : 'How It Works',
					onclick : function() {
